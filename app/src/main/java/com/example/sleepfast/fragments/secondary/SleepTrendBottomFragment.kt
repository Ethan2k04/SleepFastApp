...
class SleepTrendBottomFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bottom_sleep_trend, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val cancelButton: ImageButton = requireView().findViewById(R.id.sleepTrendCancelButton)
