...
class SoundBottomFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bottom_sound, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val cancelButton: ImageButton = requireView().findViewById(R.id.soundTrackCancelButton)
